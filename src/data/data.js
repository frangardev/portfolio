...
const Data = [
  ...
  },
  {
    ...
    description: {
      isList: false,
      text: ["Sitio hecho en WordPress para P.AP. Monterrey."],
    },
  ...
  },
  {
    name: "Clon de Google",
    image: [
      "https://i.ibb.co/rGFfnBx/clon-de-google-white.png",
      "https://i.ibb.co/h8dKf0Q/clon-de-google-black.png",
    ],
    url: "https://frangardev.github.io/Clon-de-Google/",
    repository: "https://github.com/frangardev/Clon-de-Google",
    description: {
      isList: true,
      text: ["Clon dela página de Google.", "Cuenta con Dark Mode."],
    },
  ...
  },
  {
    name: "PokeTeam",
    image: [
      "https://i.ibb.co/xDsvkwt/poketeam-img1.png",
  ...
  // },
  {
    ...
    repository:
      "https://github.com/frangardev/ejercicios-javascript/tree/main/figuras",
    description: {
      isList: true,
      text: [
  ...
  },
  {
    name: "Rick and Morty",
    image: [
      "https://i.ibb.co/qChpKL5/rick-and-morty-black.png",
      "https://i.ibb.co/FKJWMGh/rick-and-morty-light.png",
    ],
  ...
  },
  {
    name: "SPA Marvel",
    image: [
      "https://i.ibb.co/qrQb0y6/spa-marvel-frond.png",
      "https://i.ibb.co/wRdgNZN/spa-marvel-2.png",
    ],
